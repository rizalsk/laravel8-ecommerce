    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="wrap-product-detail">
                                    ...
                                    @foreach ($gallery as $img)
                                        @if ($img !== '')
                                            <li data-thumb="{{ asset('assets/images/products') }}/{{$img}}">
                                                <img src="{{ asset('assets/images/products') }}/{{$img}}" alt="{{$product->name}}" />
                                            </li>        
                                        @endif
                                    @endforeach
                                @endif
                    ...
                    <div class="advance-info">
                        <div class="tab-control normal">
                            ...
                            <a href="#attributes" class="tab-control-item">Attribute</a>
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="attributes">
            ...
            <div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wrap-show-advance-info-box style-1 box-in-site w-full">
