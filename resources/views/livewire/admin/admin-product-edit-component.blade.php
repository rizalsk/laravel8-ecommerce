            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-light">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" id="f-product" wire:submit.prevent="update">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="name" wire:change="generateSlug"
                                                wire:keyup="generateSlug" type="text" name="name" class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="slug" type="text" name="slug" class="form-control"
                                                id="slug" readonly placeholder="Product Slug">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="description" name="description" class="form-control"
                                                id="description" placeholder="Description" row="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="sale_price" type="number" name="sale_price"
                                                class="form-control" id="sale_price" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select wire:model="stoct_status" id="stoct_status" name="stoct_status"
                                                class="form-control" style="width: 100%;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select wire:model="featured" id="featured" name="featured"
                                                class="form-control" style="width: 100%;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="quantity" type="number" name="quantity"
                                                class="form-control" id="quantity" placeholder="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="bg-sky-300 h-48">
                                                ...
                                                @else
                                                    <img class="object-contain hover:object-scale-down" src="{{ asset('assets/images/products') }}/{{ $imageName }}" width="100">
                                                @endif
                                                ...
                                                <div class="flex">
                                                    ...
                                                    @else 
                                                        ...
                                                        @foreach ($galleries as $img)
                                                            @if ($img != '')
                                                                <img class="" width="70" src="{{ asset('assets/images/products') }}/{{$img}}">
                                                            @endif
                                                        @endforeach
                                                    @endif
                                                </div>
