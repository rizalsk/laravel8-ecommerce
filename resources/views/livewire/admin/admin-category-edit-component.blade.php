            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-light">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" id="f-category" wire:submit.prevent="update">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="slug" type="text" name="slug" class="form-control"
                                                id="slug" readonly placeholder="Category Slug">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row border-top mt-3 pt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="selectAttribute" wire:model="selectedAttributes" placeholder="-- select attribute --" class="form-control" name="selectedAttributes[]" multiple="multiple" >
